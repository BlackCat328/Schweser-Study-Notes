...
import { ref, getCurrentInstance, onBeforeMount, onMounted, onBeforeUpdate, onUpdated, onBeforeUnmount, onUnmounted, onRenderTracked, onRenderTriggered } from 'vue';
// beforeCreate created，在 setup 语法糖中是没有这两个生命周期的，就是用 setup 去代替

//获取当前组件的实例
const instance = getCurrentInstance()
// setup 首先执行
console.log('setup执行','当前组件shi'li',instance);
